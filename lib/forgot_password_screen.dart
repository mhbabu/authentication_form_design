        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text('Forgot Password', style: TextStyle(fontSize: 24, fontFamily: 'Rubik Medium', color: Color(0xff2D3142))),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Send Mail', style: TextStyle(fontSize: 16, fontFamily: 'Rubik Medium', color: Colors.white, letterSpacing: 1)),
                ),
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Create new account? ", style: TextStyle(fontSize: 14, fontFamily: 'Rubik Regular', color: Color(0xff4C5980))),
                  GestureDetector(
